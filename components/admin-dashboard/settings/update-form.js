        ...
        <>
            <Row gutter={[20, 52]} align={'middle'} justify={'center'} style={{ marginBottom: 30 }}>
                <Col span={24} className={styles.searchBar}>
                    <Input placeholder='Search agent here' prefix={<FaSearch color='#888' size={18} />} className={styles.searchInput} onChange={() => { }} />
                    <Button className={styles.searchBtn}>Search</Button>
                </Col>
            </Row>
            <Row gutter={[20, 52]} style={{ marginBottom: 30 }}>
                {/* <Col xs={24} lg={12}>
                ...
                {/* <Col xs={24} lg={12}>
                    <Card hoverable className={[styles.userCard, 'userCard']}>
                        ...
                        <Text className={styles.username}>text</Text>
                    </Card>
                </Col> */}
            </Row>
            <Card className={[styles.card, 'registerCard']}>
                <Row justify='center' align='midde' gutter={[20, 20]} className={styles.cardRow}>
                    ...
                    <Col span={24} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Button className={styles.btn} disabled={disabled}>Register</Button>
                    </Col>
                </Row>
            </Card>
        </>
